    ...
    <div id="primary" class="content-front-page">
        <main id="main" class="site-main" role="main">
            ...
            <section class="we-need">
                <div class="dos">
                    <div class="one">
                        <p>The New Westminster Montessori Society is a volonteer run registered charity committed to promoting
                            and developing Montessori education in the public school system. We have committed to the school
                            Board to provide all of the materials needed for all existing and new Montessori classrooms.</p>
                        <div class="quote-block" <div>
                            <div class="quote-line"></div>
                            <div class="quote-voluntering"><b>Volunteering and donations</b> are essential in order for the Montessori program to continue
                                to operate and provide the best education to all our children.</div>
                        </div>
                        <!--quote block-->
                        <p>It cost approximately $15,000 to properly equip a classroom with Montessori materials, with ongoing
                            cost each year.
                        </p>
                        <p>This amount can be raised if all parents in the program donate <b>$100 per child per year or $10 per month</b>                            for 10 months. All donations are strictly voluntary, tax-deductible, and not mandatory.
                        </p>
                    </div>
                    <!--one-->
                    <div class="ja">
